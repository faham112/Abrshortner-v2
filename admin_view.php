...
<p style="font-size:13px;color:var(--accent);margin-bottom:6px;">https://<?= $host ?>/<?= htmlspecialchars($stats['short_code']) ?></p>
<?php else: ?><div class="empty">Select a link and tap Stats</div><?php endif; ?>
</div>
